...
//1 EUR = 62.98 RUB
        ...
        printkonverzija(vrednost, " EUR je ", iznosKonverzije, " " + valuta);
    }

    public static double konverzija(int a, String b) {
        if (b.equals("RSD")) {
            return 117.5 * a;
        } else if (b.equals("USD")) {
            return 1.1 * a;
        } else if (b.equals("RUB")) {
            return 62.98 * a;
        } else return 0;
    }

    public static void printkonverzija(int a, String b, double c, String d) {
