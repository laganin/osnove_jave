...
//
//Napišite program koji simulira prikazivanje korisnika na Slacku. Prikaz korisnika treba da se izvede tako da prvo budu prikazani aktivni korisnici, a potom neaktivni.
...
//| slika |x Uros Urosevic
        ...
        for (int i = 0; i < user.size(); i++) {
            boolean aktivnost = online.get(i);
            String korisnik = user.get(i);
            if (aktivnost == true) {
                System.out.println("| slika | o " + korisnik);
            } else System.out.println("| slika | x " + korisnik);
